...
The simplest and most widely recommended option is [Tor Browser](https://www.torproject.org/download), a modified version of Firefox that automatically connects to the Tor network and applies privacy-preserving defaults. Once installed, you can open Tor Browser, wait for it to establish a connection, and then visit a `.onion` address, for example here is the `.onion` address of my website [http://7eufinpff72b7ziin4d46b5afh6a7la2mb4ievknde2tjrdjlukiyqyd.onion/](http://7eufinpff72b7ziin4d46b5afh6a7la2mb4ievknde2tjrdjlukiyqyd.onion/), just like you would visit a regular website. No additional configuration is required for most users.
...
- [The Guardian](https://www.guardian2zotagl6tmjucg3lrhxdk4dw3lhbqnkvvkywawy3oqfoprid.onion/us)
